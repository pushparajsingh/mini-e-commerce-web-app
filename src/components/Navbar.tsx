...
export const Navbar: React.FC = () => {
  const { cartItems, theme, toggleTheme, toggleDrawer } = useCart();
      ...
      <div className={`${styles.navContainer} container`}>
        ...
        <Link to="/" className={styles.logoLink}>
          <div className={styles.logo}>
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className={styles.logoIcon}>
            ...
            <span className={styles.logoText}>
              Quick<span className={styles.logoHighlight}>Basket</span>
            </span>
          </div>
        </Link>
        ...
        <div className={styles.actions}>
          ...
          >
            ...
            {totalItems > 0 && (
              <span key={totalItems} className={`${styles.cartBadge} animate-pop-in`}>
                {totalItems}
              </span>
            )}
          </button>
